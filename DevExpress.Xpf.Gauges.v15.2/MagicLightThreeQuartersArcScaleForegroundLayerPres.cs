...
// Type: DevExpress.Xpf.Gauges.MagicLightThreeQuartersArcScaleForegroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class MagicLightThreeQuartersArcScaleForegroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    public override string PresentationName
    {
      get
      {
        return "Magic Light Three Quarters Foreground";
      }
    }
    ...
    {
      return (PresentationControl) new MagicLightThreeQuartersArcScaleForegroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new MagicLightThreeQuartersArcScaleForegroundLayerPresentation();
    }
  }
}
