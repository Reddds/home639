...
// Type: DevExpress.Xpf.Gauges.MagicLightArcScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class MagicLightArcScaleMarkerPresentation : PredefinedArcScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new MagicLightArcScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new MagicLightArcScaleMarkerPresentation();
    }
  }
}
