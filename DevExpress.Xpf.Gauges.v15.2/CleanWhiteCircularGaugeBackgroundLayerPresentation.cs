...
// Type: DevExpress.Xpf.Gauges.CleanWhiteCircularGaugeBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CleanWhiteCircularGaugeBackgroundLayerPresentation : PredefinedCircularGaugeLayerPresentation
  {
    ...
    {
      return (PresentationControl) new CleanWhiteGaugeBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CleanWhiteCircularGaugeBackgroundLayerPresentation();
    }
  }
}
