...
// Type: DevExpress.Xpf.Gauges.ScaleCustomElementCollection
...
namespace DevExpress.Xpf.Gauges
{
  ...
  public class ScaleCustomElementCollection : GaugeElementCollection<ScaleCustomElement>
  {
    ...
    /// 
    /// <para>
    /// Initializes a new instance of the ScaleCustomElementCollection class with the specified owner.
    /// 
    /// </para>
    /// 
    /// </summary>
    /// <param name="scale">A <see cref="T:DevExpress.Xpf.Gauges.Scale"/> object that should be the owner of the created collection.
    /// 
    ///             </param>
