...
// Type: DevExpress.Xpf.Gauges.CleanWhiteArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CleanWhiteArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new CleanWhiteArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CleanWhiteArcScaleLinePresentation();
    }
  }
}
