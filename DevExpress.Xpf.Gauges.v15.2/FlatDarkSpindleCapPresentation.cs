...
// Type: DevExpress.Xpf.Gauges.FlatDarkSpindleCapPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkSpindleCapPresentation : PredefinedSpindleCapPresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkSpindleCapControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkSpindleCapPresentation();
    }
  }
}
