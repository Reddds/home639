...
// Type: DevExpress.Xpf.Gauges.IStyleCircularGaugeBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class IStyleCircularGaugeBackgroundLayerPresentation : PredefinedCircularGaugeLayerPresentation
  {
    ...
    {
      return (PresentationControl) new IStyleGaugeBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new IStyleCircularGaugeBackgroundLayerPresentation();
    }
  }
}
