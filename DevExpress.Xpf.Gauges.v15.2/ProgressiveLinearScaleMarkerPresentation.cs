...
// Type: DevExpress.Xpf.Gauges.ProgressiveLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class ProgressiveLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new ProgressiveLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new ProgressiveLinearScaleMarkerPresentation();
    }
  }
}
