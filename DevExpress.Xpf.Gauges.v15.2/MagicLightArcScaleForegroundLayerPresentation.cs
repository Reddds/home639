...
// Type: DevExpress.Xpf.Gauges.MagicLightArcScaleForegroundLayerPresentation
  ...
  public class MagicLightArcScaleForegroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    protected override Brush DefaultFill
    {
      get
      {
        ...
        {
          Color = Color.FromArgb(byte.MaxValue, (byte) 148, (byte) 238, byte.MaxValue),
          Offset = 0.0
        });
        linearGradientBrush.GradientStops.Add(new GradientStop()
        {
    ...
    {
      return (PresentationControl) new MagicLightArcScaleForegroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new MagicLightArcScaleForegroundLayerPresentation();
    }
  }
}
