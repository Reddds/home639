...
// Type: DevExpress.Xpf.Gauges.CosmicArcScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CosmicArcScaleMarkerPresentation : PredefinedArcScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new CosmicArcScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CosmicArcScaleMarkerPresentation();
    }
  }
}
