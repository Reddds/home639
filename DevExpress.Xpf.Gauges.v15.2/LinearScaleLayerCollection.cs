...
// Type: DevExpress.Xpf.Gauges.LinearScaleLayerCollection
...
namespace DevExpress.Xpf.Gauges
{
  ...
  public class LinearScaleLayerCollection : LayerCollection<LinearScaleLayer>
  {
    ...
    /// 
    /// <para>
    /// Initializes a new instance of the LinearScaleLayerCollection class with the specified owner.
    /// 
    /// </para>
    /// 
    /// </summary>
    ...
    /// 
    ///             </param>
    public LinearScaleLayerCollection(LinearScale scale)
      : base((Scale) scale)
    {
    }
  }
