...
// Type: DevExpress.Xpf.Gauges.DefaultLinearScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultLinearScaleLinePresentation : PredefinedLinearScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new DefaultLinearScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultLinearScaleLinePresentation();
    }
  }
}
