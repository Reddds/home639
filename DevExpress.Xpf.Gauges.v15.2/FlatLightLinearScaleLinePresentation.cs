...
// Type: DevExpress.Xpf.Gauges.FlatLightLinearScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatLightLinearScaleLinePresentation : PredefinedLinearScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new FlatLightLinearScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatLightLinearScaleLinePresentation();
    }
  }
}
