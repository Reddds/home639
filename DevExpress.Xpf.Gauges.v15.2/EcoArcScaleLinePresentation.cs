...
// Type: DevExpress.Xpf.Gauges.EcoArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class EcoArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new EcoArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new EcoArcScaleLinePresentation();
    }
  }
}
