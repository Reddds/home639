...
// Type: DevExpress.Xpf.Gauges.CleanWhiteLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CleanWhiteLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    public override string PresentationName
    {
      get
      {
        return "Clean White Marker";
      }
    }

    protected internal override PresentationControl CreateIndicatorPresentationControl()
    {
      return (PresentationControl) new CleanWhiteLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CleanWhiteLinearScaleMarkerPresentation();
    }
  }
}
