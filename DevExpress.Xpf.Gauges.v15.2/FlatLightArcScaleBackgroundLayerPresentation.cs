...
// Type: DevExpress.Xpf.Gauges.FlatLightArcScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatLightArcScaleBackgroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new FlatLightArcScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatLightArcScaleBackgroundLayerPresentation();
    }
  }
}
