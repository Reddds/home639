...
// Type: DevExpress.Xpf.Gauges.FutureLinearScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FutureLinearScaleLinePresentation : PredefinedLinearScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new FutureLinearScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FutureLinearScaleLinePresentation();
    }
  }
}
