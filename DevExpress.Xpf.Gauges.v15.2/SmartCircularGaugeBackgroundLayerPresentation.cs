...
// Type: DevExpress.Xpf.Gauges.SmartCircularGaugeBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class SmartCircularGaugeBackgroundLayerPresentation : PredefinedCircularGaugeLayerPresentation
  {
    ...
    {
      return (PresentationControl) new SmartGaugeBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new SmartCircularGaugeBackgroundLayerPresentation();
    }
  }
}
