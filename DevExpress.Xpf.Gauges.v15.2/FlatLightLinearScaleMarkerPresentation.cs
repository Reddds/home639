...
// Type: DevExpress.Xpf.Gauges.FlatLightLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatLightLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    public override string PresentationName
    {
      get
      {
        return "Flat Light Marker";
      }
    }

    protected internal override PresentationControl CreateIndicatorPresentationControl()
    {
      return (PresentationControl) new FlatLightLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatLightLinearScaleMarkerPresentation();
    }
  }
}
