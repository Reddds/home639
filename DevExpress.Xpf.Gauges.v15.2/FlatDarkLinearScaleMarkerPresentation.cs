...
// Type: DevExpress.Xpf.Gauges.FlatDarkLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkLinearScaleMarkerPresentation();
    }
  }
}
