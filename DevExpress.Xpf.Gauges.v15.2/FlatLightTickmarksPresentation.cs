...
// Type: DevExpress.Xpf.Gauges.FlatLightTickmarksPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatLightTickmarksPresentation : PredefinedTickmarksPresentation
  {
    ...
    {
      return (PresentationControl) new FlatLightMinorTickmarkControl();
    }

    protected internal override PresentationControl CreateMajorTickPresentationControl()
    {
      return (PresentationControl) new FlatLightMajorTickmarkControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatLightTickmarksPresentation();
    }
  }
}
