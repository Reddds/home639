...
// Type: DevExpress.Xpf.Gauges.EcoLinearScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class EcoLinearScaleLinePresentation : PredefinedLinearScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new EcoLinearScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new EcoLinearScaleLinePresentation();
    }
  }
}
