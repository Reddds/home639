...
// Type: DevExpress.Xpf.Gauges.FlatDarkLinearScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkLinearScaleBackgroundLayerPresentation : PredefinedLinearScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkLinearScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkLinearScaleBackgroundLayerPresentation();
    }
  }
}
