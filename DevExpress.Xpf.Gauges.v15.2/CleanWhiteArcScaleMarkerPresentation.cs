...
// Type: DevExpress.Xpf.Gauges.CleanWhiteArcScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CleanWhiteArcScaleMarkerPresentation : PredefinedArcScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new CleanWhiteArcScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CleanWhiteArcScaleMarkerPresentation();
    }
  }
}
