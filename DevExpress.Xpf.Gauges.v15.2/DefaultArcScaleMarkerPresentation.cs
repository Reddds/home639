...
// Type: DevExpress.Xpf.Gauges.DefaultArcScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultArcScaleMarkerPresentation : PredefinedArcScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new DefaultArcScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultArcScaleMarkerPresentation();
    }
  }
}
