...
// Type: DevExpress.Xpf.Gauges.DefaultSpindleCapPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultSpindleCapPresentation : PredefinedSpindleCapPresentation
  {
    ...
    {
      return (PresentationControl) new DefaultSpindleCapControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultSpindleCapPresentation();
    }
  }
}
