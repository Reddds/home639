...
// Type: DevExpress.Xpf.Gauges.MagicLightCircularGaugeBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class MagicLightCircularGaugeBackgroundLayerPresentation : PredefinedCircularGaugeLayerPresentation
  {
    ...
    {
      return (PresentationControl) new MagicLightGaugeBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new MagicLightCircularGaugeBackgroundLayerPresentation();
    }
  }
}
