...
// Type: DevExpress.Xpf.Gauges.IStyleArcScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class IStyleArcScaleBackgroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new IStyleArcScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new IStyleArcScaleBackgroundLayerPresentation();
    }
  }
}
