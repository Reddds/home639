...
// Type: DevExpress.Xpf.Gauges.IStyleLinearScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class IStyleLinearScaleBackgroundLayerPresentation : PredefinedLinearScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new IStyleLinearScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new IStyleLinearScaleBackgroundLayerPresentation();
    }
  }
}
