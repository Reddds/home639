...
// Type: DevExpress.Xpf.Gauges.DefaultLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new DefaultLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultLinearScaleMarkerPresentation();
    }
  }
}
