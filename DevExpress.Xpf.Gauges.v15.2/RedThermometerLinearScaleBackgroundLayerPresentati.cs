...
// Type: DevExpress.Xpf.Gauges.RedThermometerLinearScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class RedThermometerLinearScaleBackgroundLayerPresentation : PredefinedLinearScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new RedThermometerLinearScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new RedThermometerLinearScaleBackgroundLayerPresentation();
    }
  }
}
