...
// Type: DevExpress.Xpf.Gauges.FutureArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FutureArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new FutureArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FutureArcScaleLinePresentation();
    }
  }
}
