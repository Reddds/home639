...
// Type: DevExpress.Xpf.Gauges.SmartArcScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class SmartArcScaleBackgroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new SmartArcScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new SmartArcScaleBackgroundLayerPresentation();
    }
  }
}
