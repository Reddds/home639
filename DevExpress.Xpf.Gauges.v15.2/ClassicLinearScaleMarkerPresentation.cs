...
// Type: DevExpress.Xpf.Gauges.ClassicLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class ClassicLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new ClassicLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new ClassicLinearScaleMarkerPresentation();
    }
  }
}
