...
// Type: DevExpress.Xpf.Gauges.FutureLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FutureLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new FutureLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FutureLinearScaleMarkerPresentation();
    }
  }
}
