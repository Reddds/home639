...
// Type: DevExpress.Xpf.Gauges.CosmicArcScaleNeedlePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CosmicArcScaleNeedlePresentation : PredefinedArcScaleNeedlePresentation
  {
    ...
    {
      return (PresentationControl) new CosmicArcScaleNeedleControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CosmicArcScaleNeedlePresentation();
    }
  }
}
