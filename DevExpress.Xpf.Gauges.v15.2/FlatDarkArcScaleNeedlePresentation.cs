...
// Type: DevExpress.Xpf.Gauges.FlatDarkArcScaleNeedlePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkArcScaleNeedlePresentation : PredefinedArcScaleNeedlePresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkArcScaleNeedleControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkArcScaleNeedlePresentation();
    }
  }
}
