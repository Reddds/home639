...
// Type: DevExpress.Xpf.Gauges.FlatDarkArcScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkArcScaleBackgroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkArcScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkArcScaleBackgroundLayerPresentation();
    }
  }
}
