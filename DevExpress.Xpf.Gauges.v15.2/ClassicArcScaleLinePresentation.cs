...
// Type: DevExpress.Xpf.Gauges.ClassicArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class ClassicArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new ClassicArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new ClassicArcScaleLinePresentation();
    }
  }
}
