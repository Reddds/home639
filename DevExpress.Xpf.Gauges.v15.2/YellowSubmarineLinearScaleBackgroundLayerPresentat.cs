...
// Type: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class YellowSubmarineLinearScaleBackgroundLayerPresentation : PredefinedLinearScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new YellowSubmarineLinearScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new YellowSubmarineLinearScaleBackgroundLayerPresentation();
    }
  }
}
