...
// Type: DevExpress.Xpf.Gauges.DefaultArcScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultArcScaleBackgroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new DefaultArcScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultArcScaleBackgroundLayerPresentation();
    }
  }
}
