...
// Type: DevExpress.Xpf.Gauges.FlatLightArcScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatLightArcScaleMarkerPresentation : PredefinedArcScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new FlatLightArcScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatLightArcScaleMarkerPresentation();
    }
  }
}
