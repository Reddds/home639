...
// Type: DevExpress.Xpf.Gauges.CosmicArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CosmicArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new CosmicArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CosmicArcScaleLinePresentation();
    }
  }
}
