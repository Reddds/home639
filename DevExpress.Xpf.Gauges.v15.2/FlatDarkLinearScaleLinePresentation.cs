...
// Type: DevExpress.Xpf.Gauges.FlatDarkLinearScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkLinearScaleLinePresentation : PredefinedLinearScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkLinearScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkLinearScaleLinePresentation();
    }
  }
}
