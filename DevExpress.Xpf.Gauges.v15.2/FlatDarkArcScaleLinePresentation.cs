...
// Type: DevExpress.Xpf.Gauges.FlatDarkArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class FlatDarkArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new FlatDarkArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new FlatDarkArcScaleLinePresentation();
    }
  }
}
