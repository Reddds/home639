...
// Type: DevExpress.Xpf.Gauges.ProgressiveLinearScaleLevelBarPresentation
  ...
  public class ProgressiveLinearScaleLevelBarPresentation : PredefinedLinearScaleLevelBarPresentation
  {
    protected override Brush DefaultFill
    {
      get
      {
        ...
        linearGradientBrush.GradientStops.Add(new GradientStop()
        {
          Color = Color.FromArgb(byte.MaxValue, (byte) 54, (byte) 164, (byte) 203),
          Offset = 1.0
        });
    ...
    public override string PresentationName
    {
      get
      {
        return "Progressive Level Bar";
      }
    }

    protected internal override PresentationControl CreateIndicatorPresentationControl()
    {
      return (PresentationControl) new ProgressiveLinearScaleLevelBarBackgroundControl();
    }

    protected internal override PresentationControl CreateForegroundPresentationControl()
    {
      return (PresentationControl) new ProgressiveLinearScaleLevelBarForegroundControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new ProgressiveLinearScaleLevelBarPresentation();
    }
  }
}
