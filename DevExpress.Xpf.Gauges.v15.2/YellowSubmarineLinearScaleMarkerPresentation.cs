...
// Type: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleMarkerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class YellowSubmarineLinearScaleMarkerPresentation : PredefinedLinearScaleMarkerPresentation
  {
    ...
    {
      return (PresentationControl) new YellowSubmarineLinearScaleMarkerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new YellowSubmarineLinearScaleMarkerPresentation();
    }
  }
}
