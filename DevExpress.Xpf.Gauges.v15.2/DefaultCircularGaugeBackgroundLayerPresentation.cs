...
// Type: DevExpress.Xpf.Gauges.DefaultCircularGaugeBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultCircularGaugeBackgroundLayerPresentation : PredefinedCircularGaugeLayerPresentation
  {
    ...
    {
      return (PresentationControl) new DefaultGaugeBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultCircularGaugeBackgroundLayerPresentation();
    }
  }
}
