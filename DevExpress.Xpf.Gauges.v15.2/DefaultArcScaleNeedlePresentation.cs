...
// Type: DevExpress.Xpf.Gauges.DefaultArcScaleNeedlePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultArcScaleNeedlePresentation : PredefinedArcScaleNeedlePresentation
  {
    ...
    {
      return (PresentationControl) new DefaultArcScaleNeedleControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultArcScaleNeedlePresentation();
    }
  }
}
