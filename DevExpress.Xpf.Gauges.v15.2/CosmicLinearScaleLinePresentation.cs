...
// Type: DevExpress.Xpf.Gauges.CosmicLinearScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class CosmicLinearScaleLinePresentation : PredefinedLinearScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new CosmicLinearScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new CosmicLinearScaleLinePresentation();
    }
  }
}
