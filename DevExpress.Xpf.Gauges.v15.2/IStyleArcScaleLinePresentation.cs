...
// Type: DevExpress.Xpf.Gauges.IStyleArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class IStyleArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new IStyleArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new IStyleArcScaleLinePresentation();
    }
  }
}
