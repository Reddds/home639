...
// Type: DevExpress.Xpf.Gauges.EcoLinearScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class EcoLinearScaleBackgroundLayerPresentation : PredefinedLinearScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new EcoLinearScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new EcoLinearScaleBackgroundLayerPresentation();
    }
  }
}
