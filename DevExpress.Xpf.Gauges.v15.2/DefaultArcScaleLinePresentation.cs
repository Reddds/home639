...
// Type: DevExpress.Xpf.Gauges.DefaultArcScaleLinePresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class DefaultArcScaleLinePresentation : PredefinedArcScaleLinePresentation
  {
    ...
    {
      return (PresentationControl) new DefaultArcScaleLineControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new DefaultArcScaleLinePresentation();
    }
  }
}
