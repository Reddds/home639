...
// Type: DevExpress.Xpf.Gauges.MagicLightArcScaleBackgroundLayerPresentation
...
namespace DevExpress.Xpf.Gauges
{
  public class MagicLightArcScaleBackgroundLayerPresentation : PredefinedArcScaleLayerPresentation
  {
    ...
    {
      return (PresentationControl) new MagicLightArcScaleBackgroundLayerControl();
    }

    protected override GaugeDependencyObject CreateObject()
    {
      return (GaugeDependencyObject) new MagicLightArcScaleBackgroundLayerPresentation();
    }
  }
}
