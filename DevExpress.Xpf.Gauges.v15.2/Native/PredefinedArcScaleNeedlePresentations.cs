...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedArcScaleNeedlePresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedArcScaleNeedlePresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedArcScaleNeedlePresentations.kinds;
      }
    }

    static PredefinedArcScaleNeedlePresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedArcScaleNeedlePresentations.kinds, typeof (PredefinedArcScaleNeedlePresentation));
    }
  }
}
