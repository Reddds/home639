...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearScaleLevelBarPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearScaleLevelBarPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearScaleLevelBarPresentations.kinds;
      }
    }

    static PredefinedLinearScaleLevelBarPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearScaleLevelBarPresentations.kinds, typeof (PredefinedLinearScaleLevelBarPresentation));
    }
  }
}
