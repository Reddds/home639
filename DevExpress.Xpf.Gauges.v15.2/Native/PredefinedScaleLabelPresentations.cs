...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedScaleLabelPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedScaleLabelPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedScaleLabelPresentations.kinds;
      }
    }

    static PredefinedScaleLabelPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedScaleLabelPresentations.kinds, typeof (PredefinedScaleLabelPresentation));
    }
  }
}
