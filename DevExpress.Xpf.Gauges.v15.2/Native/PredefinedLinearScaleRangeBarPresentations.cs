...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearScaleRangeBarPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearScaleRangeBarPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearScaleRangeBarPresentations.kinds;
      }
    }

    static PredefinedLinearScaleRangeBarPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearScaleRangeBarPresentations.kinds, typeof (PredefinedLinearScaleRangeBarPresentation));
    }
  }
}
