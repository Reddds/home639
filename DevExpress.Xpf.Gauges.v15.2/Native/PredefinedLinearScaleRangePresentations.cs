...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearScaleRangePresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearScaleRangePresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearScaleRangePresentations.kinds;
      }
    }

    static PredefinedLinearScaleRangePresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearScaleRangePresentations.kinds, typeof (PredefinedLinearScaleRangePresentation));
    }
  }
}
