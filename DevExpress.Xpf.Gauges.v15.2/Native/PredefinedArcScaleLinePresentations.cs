...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedArcScaleLinePresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedArcScaleLinePresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedArcScaleLinePresentations.kinds;
      }
    }

    static PredefinedArcScaleLinePresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedArcScaleLinePresentations.kinds, typeof (PredefinedArcScaleLinePresentation));
    }
  }
}
