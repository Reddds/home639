...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedArcScaleRangeBarPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedArcScaleRangeBarPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedArcScaleRangeBarPresentations.kinds;
      }
    }

    static PredefinedArcScaleRangeBarPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedArcScaleRangeBarPresentations.kinds, typeof (PredefinedArcScaleRangeBarPresentation));
    }
  }
}
