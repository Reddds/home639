...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedCircularGaugeLayerPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedCircularGaugeLayerPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedCircularGaugeLayerPresentations.kinds;
      }
    }

    static PredefinedCircularGaugeLayerPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedCircularGaugeLayerPresentations.kinds, typeof (PredefinedCircularGaugeLayerPresentation));
    }
  }
}
