...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearScaleMarkerPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearScaleMarkerPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearScaleMarkerPresentations.kinds;
      }
    }

    static PredefinedLinearScaleMarkerPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearScaleMarkerPresentations.kinds, typeof (PredefinedLinearScaleMarkerPresentation));
    }
  }
}
