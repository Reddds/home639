...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedArcScaleRangePresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedArcScaleRangePresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedArcScaleRangePresentations.kinds;
      }
    }

    static PredefinedArcScaleRangePresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedArcScaleRangePresentations.kinds, typeof (PredefinedArcScaleRangePresentation));
    }
  }
}
