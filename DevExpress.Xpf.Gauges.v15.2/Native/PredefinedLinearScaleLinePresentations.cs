...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearScaleLinePresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearScaleLinePresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearScaleLinePresentations.kinds;
      }
    }

    static PredefinedLinearScaleLinePresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearScaleLinePresentations.kinds, typeof (PredefinedLinearScaleLinePresentation));
    }
  }
}
