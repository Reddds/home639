...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedTickmarksPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedTickmarksPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedTickmarksPresentations.kinds;
      }
    }

    static PredefinedTickmarksPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedTickmarksPresentations.kinds, typeof (PredefinedTickmarksPresentation));
    }
  }
}
