...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedArcScaleMarkerPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedArcScaleMarkerPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedArcScaleMarkerPresentations.kinds;
      }
    }

    static PredefinedArcScaleMarkerPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedArcScaleMarkerPresentations.kinds, typeof (PredefinedArcScaleMarkerPresentation));
    }
  }
}
