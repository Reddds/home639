...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedStatePresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedStatePresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedStatePresentations.kinds;
      }
    }

    static PredefinedStatePresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedStatePresentations.kinds, typeof (PredefinedStatePresentation));
    }
  }
}
