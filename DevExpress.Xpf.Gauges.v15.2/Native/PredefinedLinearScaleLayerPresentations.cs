...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearScaleLayerPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearScaleLayerPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearScaleLayerPresentations.kinds;
      }
    }

    static PredefinedLinearScaleLayerPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearScaleLayerPresentations.kinds, typeof (PredefinedLinearScaleLayerPresentation));
    }
  }
}
