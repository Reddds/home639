...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedLinearGaugeLayerPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedLinearGaugeLayerPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedLinearGaugeLayerPresentations.kinds;
      }
    }

    static PredefinedLinearGaugeLayerPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedLinearGaugeLayerPresentations.kinds, typeof (PredefinedLinearGaugeLayerPresentation));
    }
  }
}
