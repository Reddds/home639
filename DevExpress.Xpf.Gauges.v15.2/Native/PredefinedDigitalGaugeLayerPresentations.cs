...
// Type: DevExpress.Xpf.Gauges.Native.PredefinedDigitalGaugeLayerPresentations
...
namespace DevExpress.Xpf.Gauges.Native
{
  public class PredefinedDigitalGaugeLayerPresentations : PredefinedElementKinds
  {
    ...
    public static List<PredefinedElementKind> PresentationKinds
    {
      get
      {
        return PredefinedDigitalGaugeLayerPresentations.kinds;
      }
    }

    static PredefinedDigitalGaugeLayerPresentations()
    {
      PredefinedElementKinds.FillKindList(PredefinedDigitalGaugeLayerPresentations.kinds, typeof (PredefinedDigitalGaugeLayerPresentation));
    }
  }
}
