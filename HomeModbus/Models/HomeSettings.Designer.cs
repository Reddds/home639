...
namespace HomeModbus.Models
{
    ...
    public partial class Visibility
    {
        ...
        private VisibilityDoubleIndicator _doubleIndicator;

        private object _stringIndicator;

        private object _currentTime;

        private object _sendCommand;
        ...
        public VisibilityDoubleIndicator DoubleIndicator
        {
            get
            {
                return this._doubleIndicator;
            }
            set
            {
                this._doubleIndicator = value;
            }
        }

        public object StringIndicator
        {
            get
            {
                return this._stringIndicator;
            }
            set
            {
                this._stringIndicator = value;
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class VisibilityDoubleIndicator
    {

        private System.Nullable<bool> _isHex;
        ...
        public bool IsHex
        {
            get
            {
                if (this._isHex.HasValue)
                {
                    return this._isHex.Value;
                }
                else
                {
                    return default(bool);
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool IsHexSpecified
        {
            get
            {
                return this._isHex.HasValue;
            }
            set
            {
                if (value == false)
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializerFactory().CreateSerializer(typeof(VisibilityDoubleIndicator));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current VisibilityDoubleIndicator object into an XML string
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an VisibilityDoubleIndicator object
        /// </summary>
        /// <param name="input">string workflow markup to deserialize</param>
        /// <param name="obj">Output VisibilityDoubleIndicator object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string input, out VisibilityDoubleIndicator obj, out System.Exception exception)
        {
            exception = null;
            obj = default(VisibilityDoubleIndicator);
            try
            {
                obj = Deserialize(input);
                return true;
        ...
        public static bool Deserialize(string input, out VisibilityDoubleIndicator obj)
        {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public static VisibilityDoubleIndicator Deserialize(string input)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(input);
                return ((VisibilityDoubleIndicator)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        public static VisibilityDoubleIndicator Deserialize(System.IO.Stream s)
        {
            return ((VisibilityDoubleIndicator)(Serializer.Deserialize(s)));
        }
        #endregion

        /// <summary>
        /// Serializes current VisibilityDoubleIndicator object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an VisibilityDoubleIndicator object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output VisibilityDoubleIndicator object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out VisibilityDoubleIndicator obj, out System.Exception exception)
        {
            exception = null;
            obj = default(VisibilityDoubleIndicator);
            try
        ...
        public static bool LoadFromFile(string fileName, out VisibilityDoubleIndicator obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static VisibilityDoubleIndicator LoadFromFile(string fileName)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
